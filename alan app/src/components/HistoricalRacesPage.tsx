...
const BATTLES: Battle[] = [
  ...
  },
  {
    ...
    description: 'Verstappen disqualified from qualifying for inspecting Hamilton\'s rear wing. Hamilton given two grid penalties. He drove from P10 twice in 24 hours to win on Sunday — the most relentless display of raw pace in that entire season.',
  ...
  },
  {
    ...
    description: 'Rain, crashes, a tractor on track, and a disputed podium finish. Verstappen won his second Drivers\' title in bizarre circumstances — the result was only confirmed hours after the chequered flag due to a points-adjustment controversy.',
  ...
  },
  {
    ...
    description: 'F1\'s first Las Vegas race since 1982 did not disappoint. A drain cover destroyed Sainz\'s car in practice, a red-flagged start, and a stunning last-lap overtake made this one of the most watched F1 races in American television history.',
    highlight: 'Last-lap overtake on the Strip',
